...
保存した画像ファイルやsidecar JSONには、プロンプト、キャプション、conversation ID、message ID、image ID、画像URLが含まれる場合があります。保存物を共有すると、これらの情報も共有される可能性があります。
...
│   ├── content/            # ChatGPTページ用content scriptとpage hook
