...
GPT Image Viewer does not send prompts, images, metadata, or conversation data to any external server. The developer does not sell, transfer, or share user data with third parties.
...
GPT Image Viewer は、プロンプト、画像、メタデータ、会話データを外部サーバーへ送信しません。開発者はユーザーデータを第三者へ販売、転送、共有しません。
